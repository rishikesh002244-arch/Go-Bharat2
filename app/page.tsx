...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#fafafa] text-[#14213d]">
      ...
      {/* NAVBAR */}
      <header className="absolute left-0 right-0 top-0 z-50 px-4 pt-5 md:px-10">
        <nav className="mx-auto flex max-w-[1400px] items-center justify-between rounded-full bg-white/95 px-6 py-4 shadow-lg backdrop-blur-md">
          ...
          <div className="hidden items-center gap-8 md:flex">
            <Link
              href="/"
              className="border-b-2 border-[#f97316] pb-1 text-sm font-semibold"
            >
              Home
            </Link>
          ...
          <div className="flex items-center gap-3">
            <button className="hidden h-11 w-11 items-center justify-center rounded-full bg-gray-100 text-xl md:flex">
              🔍
            </button>

            <Link
              href="/login"
              className="rounded-full bg-[#f97316] px-6 py-3 text-sm font-bold text-white shadow-md transition hover:bg-[#ea580c]"
            >
              Sign In
            </Link>
          </div>
